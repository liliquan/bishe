            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal m-t-md" action="{{route('rules.store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="fonts" id="fonts" onclick="showicon()"
                                   value="{{ old('fonts') ? old('fonts') : 'desktop'}}" placeholder="菜单图标"
                                   class="form-control">
                            ...
                            @else
                                <span class="help-block m-b-none"><i
                                            class="fa fa-info-circle"></i> 采用Font Awesome字体图标</span>
                            @endif
                        </div>
                    </div>
                    <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <input type="text" name="sort" value="{{old('sort') ? old('sort') : 255 }}" required
                                   class="form-control">
                            @if ($errors->has('sort'))
