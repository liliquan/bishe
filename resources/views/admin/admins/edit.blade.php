        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <a href="{{route('admins.index')}}">
                    <button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 管理员管理
                    </button>
                </a>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <form class="form-horizontal m-t-md" action="{{ route('admins.update',$admin->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                           ...
                           <img id="thumbnail-avatar" class="thumbnail img-responsive" src="{{$admin->avatr}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-2">
                            ...
                            @foreach($roles as $k=>$item)
                                <label><input type="checkbox" name="role_id[]" value="{{$item->id}}"
                                              @if(in_array($item->id,$ruleids)) checked="checked" @endif> {{$item->name}}
                                </label><br/>
                            @endforeach
